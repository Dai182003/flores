...
var lyricsData = [
  ...
  { text: "En ese bar tan desierto nos esperaba el encuentro", time: 73 },
  { text: "Ella llegó en limusina amarilla por supuesto", time: 82 },
  { text: "Él se acercó de repente la miro tan de frente", time: 89 },
  { text: "Toda una vida soñada y no pudo decir nada", time: 98 },
